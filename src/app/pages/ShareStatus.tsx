    ...
    <div className="flex flex-col h-full bg-slate-800">
      ...
      <div className="flex-1 p-6 flex flex-col gap-8">
        <div className="bg-slate-700 rounded-[32px] p-6 border border-slate-600 shadow-sm">
          ...
          <div className="space-y-5">
            <div className="flex justify-between items-center">
              ...
              <span className="text-slate-50 font-bold">강남역 2번 출구</span>
            </div>
            <div className="flex justify-between items-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="w-full bg-[#FEE500] text-[#191919] rounded-[20px] p-5 flex items-center justify-center font-bold text-lg hover:bg-[#F4DC00] transition-colors active:scale-95 shadow-sm">
          ...
          <button className="w-full bg-slate-700 text-blue-300 border border-slate-600 rounded-[20px] p-5 flex items-center justify-center font-bold text-lg hover:bg-slate-600 transition-colors active:scale-95 shadow-sm">
            <Send className="w-5 h-5 mr-2" />
            문자 메시지(SMS)
          </button>
          
          <button className="w-full bg-transparent border border-slate-600 text-slate-200 rounded-[20px] p-5 flex items-center justify-center font-medium text-lg hover:bg-slate-700 transition-colors shadow-sm active:scale-95">
